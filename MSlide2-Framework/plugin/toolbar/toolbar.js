  ...
  (function() {
    ...
    function loadPlugin() {
      ...
      if (initialise) {
        ...
        var downloadApp = option(options.downloadApp, pwaInstalled);
        ...
        function createToolbarButton(icon, cb) {
          ...
          if (icon === 'iconoir-download-square'){
            button.title = 'Add this app on your home screen for easy access and native like feel';
          }
        ...
        if (showFullscreen) {
          dom.fullscreenButton = createToolbarButton('iconoir-expand', function() {
        ...
        if (screenfull.enabled) {
          screenfull.on('change', function() {
            ...
            icon.classList.remove(
              screenfull.isFullscreen ? 'iconoir-expand' : 'iconoir-arrow-union-vertical'
            );
            icon.classList.add(
              screenfull.isFullscreen ? 'iconoir-arrow-union-vertical' : 'iconoir-expand'
            );
          });
        }
        ...
        if (captureMenu) {
          ...
          var id_menu = setInterval(function() {
            if (RevealMenu && RevealMenu.isInit && RevealMenu.isInit()) {
        ...
        if (!downloadApp) {
          ...
          dom.downloadApp = createToolbarButton('iconoir-download-square', async function() {
            ...
            if (outcome === 'accepted') {
              dom.downloadApp.style.display = 'none';
            }
          });
        }
