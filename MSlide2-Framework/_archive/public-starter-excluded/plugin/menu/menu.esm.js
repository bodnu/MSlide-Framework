                  ...
                  case 2:
                    ...
                    for (h = 0; h < sections.length; h++) {
                      ...
                      for (v = 0; v < subsections.length; v++) {
                        ...
                        imagePath = customThumb && customThumb.trim() ? customThumb : "assets/thumbnails/section-".concat(h, "-").concat(v, ".png"); // Store image path
  ...
  function initMenu() {
    if (!initialised) {
      ...
      var generateItem = function generateItem(type, section, i, h, v) {
        ...
        if (!img || !img.trim()) {
          img = "assets/thumbnails/section-".concat(h, "-").concat(v === undefined ? 0 : v, ".png");
        }
        if (img) {
